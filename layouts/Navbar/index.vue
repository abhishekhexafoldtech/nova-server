<template>
  <nav id="navbarBlur" :class="navStore.navFixed
      ? `navbar navbar-main navbar-expand-lg p-0 mx-4 border-radius-xl shadow-none position-sticky left-auto top-2 z-index-sticky ${navStore.darkMode ? 'bg-default' : 'bg-white'
      }`
      : `navbar navbar-main navbar-expand-lg p-0 mx-4 border-radius-xl shadow-none`
    " v-bind="$attrs" data-scroll="true">
    <div class="p-0 py-4 container-fluid">
      ...
      <div id="navbar" class="mt-2 mt-sm-0 me-md-0 me-sm-4">
        ...
        <ul class="d-flex m-0 p-0">
          <li class="nav-item dropdown d-flex align-items-center pe-2">
            <a id="dropdownMenuButton" href="#"
              :class="`p-0 nav-link text-white ${navStore.miniNotification ? 'show' : ''}`" data-bs-toggle="dropdown"
              aria-expanded="false" @click="navStore.miniNotification = !navStore.miniNotification">
