    ...
    <el-col :xs="24" :sm="24" :md="12" :lg="12">
      <div class="cd_box">
        <div class="prod_heading">
          <h4 class="cd_heading">Depot Details</h4>
          <button @click="handleDepotDetails">
            <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
          </button>
        </div>
        <div class="cd_list">
          <div class="cd_item">
            <img :src="depot_name" alt="" srcset="" />
            <h4>Name of depot:<span>Gas agency</span></h4>
          </div>
          <div class="cd_item">
            <img :src="Phone" alt="" srcset="" />
            <h4>Depot number:<span>0277400000</span></h4>
          </div>
          <div class="cd_item">
            <img :src="Email" alt="" srcset="" />
            <h4>Depot email:<span>kwatsons@gmail.com</span></h4>
          </div>
        </div>
        <div class="mt-5">
          <div class="prod_heading">
          ...
          <div class="cd_list">
            <div class="cd_item">
              ...
              <h4>Insurance company:<span>Gas agency</span></h4>
            </div>
            <div class="cd_item">
              <img :src="PolicyNumber" alt="" srcset="" />
              <h4>Policy number:<span>4523</span></h4>
            </div>
            <div class="cd_item">
              <img :src="Calender" alt="" srcset="" />
              <h4>Expiry:<span>2028/02/18</span></h4>
            </div>
          </div>
        </div>
      </div>
...
<script setup>
import depot_name from "@/assets/svg/depot_name.svg";
...
// moving to buisinedd details add form
function handleDepotDetails() {
  router.b_details = {
    name_of_depot: "Gas agency",
    depot_number: "0277400000",
    depot_email: "kwatsons@gmail.com",
  };
...
onMounted(() => {
  navStore.setBreadCrumbs("Distributor / Location / Depot / Depot details");
});
</script>
