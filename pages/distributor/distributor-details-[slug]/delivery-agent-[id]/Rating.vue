...
watch(props, (newData) => {
  if (newData) {
    data.rating = newData.avg_rating;
    data.ratingStars = generateRatingStars(data.rating);
    data.feedback[0].percentage = newData.negative_feedback_percentage;
    data.feedback[1].percentage = newData.positive_feedback_percentage;
  }
});
...
onMounted(() => {
  navStore.setBreadCrumbs(
    "Distributor / Delivery vehicles & agents / Total delivery agents / Rating");
});
