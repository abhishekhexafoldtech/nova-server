<template>
  <div class="container-area">
    ...
    <div class="cert_box">
      <h4 class="cert_title">Customer Name:<span>Mg gas ltd</span></h4>
      ...
      <div class="manufacture_check">
        <el-checkbox v-model="isVerified" label="Please confirm that you have verified the customers documents."
          name="type" />
      </div>
      <RejectForm :visible="dialog" @handleReject="handleReject" @handleCloseForm="handleClose" />
